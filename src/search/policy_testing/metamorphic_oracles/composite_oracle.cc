...
CompositeOracle::CompositeOracle(const plugins::Options &opts)
    : Oracle(opts),
...
void
CompositeOracle::add_options_to_feature(plugins::Feature &feature) {
    Oracle::add_options_to_feature(feature);
    feature.add_option<std::shared_ptr<Oracle>>("qual_oracle", "oracle for qualitative evaluation",
                                                plugins::ArgumentInfo::NO_DEFAULT);
    feature.add_option<std::shared_ptr<Oracle>>("quant_oracle", "oracle for quantitative evaluation",
                                                plugins::ArgumentInfo::NO_DEFAULT);
    feature.add_option<std::shared_ptr<Oracle>>("metamorphic_oracle", "oracle for metamorphic testing",
                                                plugins::ArgumentInfo::NO_DEFAULT);
    feature.add_option<bool>("enforce_external",
...
class CompositeOracleFeature : public plugins::TypedFeature<Oracle, CompositeOracle> {
public:
    CompositeOracleFeature() : TypedFeature("composite_oracle") {
        CompositeOracle::add_options_to_feature(*this);
    }
};
static plugins::FeaturePlugin<CompositeOracleFeature> _plugin;
} // namespace policy_testing
