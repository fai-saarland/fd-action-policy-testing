...
class HillClimbingPolicyFeature : public plugins::TypedFeature<Policy, HillClimbingPolicy> {
public:
    HillClimbingPolicyFeature() : TypedFeature("hill_climbing_policy") {
        HillClimbingPolicy::add_options_to_feature(*this);
    }
};
static plugins::FeaturePlugin<HillClimbingPolicyFeature> _plugin;
} // namespace policy_testing
