 ...
 * @param elem
 */
inline void insert_sorted(std::vector<StateID> &vec, StateID elem) {
...
public:
    ...
    explicit Policy(const plugins::Options &opts);
    Policy();
...
public:
    explicit CachedPolicy(const plugins::Options &opts) : Policy(opts) {}
    static void add_options_to_feature(plugins::Feature &feature) {
