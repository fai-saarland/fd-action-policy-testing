...
#ifdef INCLUDE_SYM
    void getAbsStateBDDs(SymVariables *vars, std::vector<BDD> &abs_bdds) const override;
    BDD getIrrelevantStateBDD(SymVariables *vars, std::vector<BDD> &abs_bdds) const override;
#endif
...
BOOST_CLASS_EXPORT(simulations::StrippedAtomicAbstraction)
BOOST_CLASS_EXPORT(simulations::StrippedCompositeAbstraction)
BOOST_CLASS_EXPORT(simulations::StrippedPDBAbstraction)
