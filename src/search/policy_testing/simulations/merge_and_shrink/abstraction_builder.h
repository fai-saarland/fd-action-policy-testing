...
public:
    explicit AbstractionBuilder(options::Options opts);
...
public:
    explicit AbsBuilderPDB(const options::Options &opts);
...
public:
    explicit AbsBuilderAtomic(const options::Options &opts);
...
/*
class AbsBuilderAtomicAdvanced : public AbstractionBuilder {
public:
    explicit AbsBuilderAtomicAdvanced(const options::Options &opts);
    ~AbsBuilderAtomicAdvanced() override = default;
    ...
    void dump_options() const override {
        std::cout << "AbsBuilderAtomicAdvanced" << std::endl;
    }
};
 */
...
public:
    explicit AbsBuilderMAS(const options::Options &opts);
...
public:
    explicit AbsBuilderDefault(const options::Options &opts);
...
public:
    explicit AbsBuilderMasSimulation(const options::Options &opts);
...
public:
    explicit AbsBuilderComposite(const options::Options &opts);
