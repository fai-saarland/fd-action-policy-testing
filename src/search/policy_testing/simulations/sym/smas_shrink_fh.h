...
protected:
    ...
    void partition_into_buckets(const SymSMAS &abs, std::vector<Bucket> &buckets) const override;

public:
    explicit SMASShrinkFH(const Options &opts);

    ~SMASShrinkFH() override = default;
